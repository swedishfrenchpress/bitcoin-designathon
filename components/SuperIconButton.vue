<template>
  ...
  >
    ...
    <svg v-if="icon == 'x'" width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12.6092 1.293h2.2053l-4.8181 5.5067 5.6683 7.4933h-4.6447l-3.4761-4.5447L2.9933 14.293H0.786667L5.9387 8.39633L0.502667 1.293h4.77867l3.14267 4.15467L12.6092 1.293ZM11.834 12.973h1.22267L3.65667 2.52633H2.34133L11.834 12.973Z" fill="currentColor"/>
    </svg>
  </component>
</template>
